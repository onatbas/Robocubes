    ...
    switch (box.getColor()) {
        case GREEN:
            return getMaterialsPath()
                    << (second ? "robot_greenDrive1.png" : "robot_greenDrive2.png"); //<< "alienGreen_square.png";
        case BLUE:
            return getMaterialsPath()
                    << (second ? "robot_blueDrive1.png" : "robot_blueDrive2.png"); //<< "alienBlue_square.png";
        case RED:
            return getMaterialsPath()
                    << (second ? "robot_redDrive1.png" : "robot_redDrive2.png"); //"alienPink_square.png";
    }
    return "";
}
