...
if ( NOT TBB_ROOT )
    ...
    set (TBB_DLL_PATH ${TBB_ROOT}/bin/${TBB_ARCH_PLATFORM}/${TBB_COMPILER})
    ...
    message ("TBB_DLL_PATH:" ${TBB_DLL_PATH})

    file(GLOB_RECURSE TBB_DLLS ${TBB_DLL_PATH}/*)
    FOREACH (DLL_NAME ${TBB_DLLS})
     install(CODE "file(COPY \"${DLL_NAME}\" DESTINATION \$\{CMAKE_INSTALL_PREFIX\})")
    ENDFOREACH()
